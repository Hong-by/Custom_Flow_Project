...
멀티 AI 워크스페이스 데스크톱 앱 (Flutter Windows)

Claude, Gemini, Notion 등 여러 AI/웹 서비스를 하나의 창에서 탭으로 관리한다.
시스템 트레이 상주 + 글로벌 핫키(F1)로 빠르게 불러올 수 있다.
